...
const { getClientes, getClienteById, createCliente, updateCliente, eliminarCliente, asignarTarifa, historialTarifas} = require('../controllers/clienteController');
...
router.delete('/:id', authMiddleware, eliminarCliente);       // Eliminar un cliente
